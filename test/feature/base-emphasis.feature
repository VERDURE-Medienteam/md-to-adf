Feature: Conversion of Emphasis markdown
  ...
  When we translate it in ADF
  Then the ADF chunk at content path [ 0 ] has type 'paragraph'
  And the ADF chunk at content path [ 0 ] contains '{ "type": "text", "text": "this sentence contains _italic_ using underscore" }'
  ...
  When we translate it in ADF
  Then the ADF chunk at content path [ 0 ] has type 'paragraph'
  And the ADF chunk at content path [ 0 ] contains '{ "type": "text", "text": "this sentence contains __bold__ using underscore" }'
  ...
  When we translate it in ADF
  Then the ADF chunk at content path [ 0 ] has type 'paragraph'
  And the ADF chunk at content path [ 0 ] contains '{ "type": "text", "text": "It's very easy to make some words _italic_ and other words __bold__ with Markdown." }'
  ...
  When we translate it in ADF
  Then the ADF chunk at content path [ 0 ] has type 'paragraph'
  And the ADF chunk at content path [ 0 ] contains '{ "type": "text", "text": "It's very easy to make some words _italic and also __bold__ with Markdown_." }'
  ...
  When we translate it in ADF
  Then the ADF chunk at content path [ 0 ] has type 'paragraph'
  And the ADF chunk at content path [ 0 ] contains '{ "type": "text", "text": "It's very easy to make some words __bold and also _italic_ with Markdown__." }'
  ...
  When we translate it in ADF
  Then the ADF chunk at content path [ 0 ] has type 'paragraph'
  And the ADF chunk at content path [ 0 ] contains '{ "type": "text", "text": "It's very __easy to make__ some words __bold and also _italic_ with__ _Markdown_." }'
